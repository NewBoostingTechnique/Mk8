...
SET scripts="%~dp0/CourseTable.sql"
SET scripts=%scripts%;"%~dp0/CourseExists.sql"
SET scripts=%scripts%;"%~dp0/CourseIdentify.sql"
SET scripts=%scripts%;"%~dp0/CourseList.sql"
